...
public interface IPriceTrackerApiClient
{
    ...
    Task<IReadOnlyList<ScrapeListingDto>> GetActiveListingsAsync(string? query = null, int? categoryId = null, Guid? storeId = null, decimal? minPrice = null, decimal? maxPrice = null, string? currencyCode = null, CancellationToken ct = default);
