...
public interface IListingRepository
{
    ...
    Task<IEnumerable<StoreProductListing>> GetActiveListingsFilteredByPreferencesAsync(int? categoryId = null, Guid? storeId = null, decimal? minPrice = null, decimal? maxPrice = null, string? currencyCode = null, int page = 0, int size = 100);
